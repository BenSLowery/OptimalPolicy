...
pub fn value_function_optimal_pol(policy : &rust::policy_contructor::OptimalPolicy, pre_action_state: (usize,usize,usize), v_t_plus_1: &HashMap<(usize, usize, usize), f64>, action_space: &Vec<(usize,usize,usize,usize,usize)>, store_expectation: &HashMap<(usize, usize, usize), f64>, warehouse_expectation: &HashMap<(usize, usize, usize), f64>,) -> ((usize, usize, usize, usize, usize),f64) {
...
pub fn value_function_pol_eval(policy : &rust::policy_contructor::OptimalPolicy, pre_action_state: (usize,usize,usize), v_t_plus_1: &HashMap<(usize, usize, usize), f64>, action: (usize,usize,usize,usize,usize), store_expectation: &HashMap<(usize, usize, usize), f64>, warehouse_expectation: &HashMap<(usize, usize, usize), f64>,) -> f64 {
    // generate action space
...
pub fn future_costs(policy: &rust::policy_contructor::OptimalPolicy, state: (usize,usize,usize), orders: (usize,usize,usize), v_t_plus_1: &HashMap<(usize, usize, usize), f64>) -> f64 {
...
pub fn terminal_cost(policy : &rust::policy_contructor::OptimalPolicy, cost: Option<f64>) -> DashMap<(usize, usize, usize), f64> {
